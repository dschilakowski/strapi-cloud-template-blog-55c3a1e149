...
// TODO/TBD: We might want to use this instead of fetching /store for each store-Attribute individually.
...
const ContentManager = () => {
  ...
  useEffect(() => {
    if (configType) {
      // TODO/TBD:
      // (Re)fetch store-Entries & set storeEntries.

      // TODO/TBD: While we use relation storeEntries we apply styling like this.
